...
local_layer parse_local(list1 *options, size_params params)
{
...
convolutional_layer parse_convolutional(list1 *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
layer parse_crnn(list1 *options, size_params params)
{
...
layer parse_rnn(list1 *options, size_params params)
{
...
layer parse_gru(list1 *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
connected_layer parse_connected(list1 *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    char *activation_s = option_find_str(options, "activation", "logistic");
    ACTIVATION activation = get_activation(activation_s);
...
softmax_layer parse_softmax(list1 *options, size_params params)
{
...
layer parse_region(list1 *options, size_params params)
{
...
detection_layer parse_detection(list1 *options, size_params params)
{
...
cost_layer parse_cost(list1 *options, size_params params)
{
...
crop_layer parse_crop(list1 *options, size_params params)
{
...
layer parse_reorg(list1 *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
maxpool_layer parse_maxpool(list1 *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
avgpool_layer parse_avgpool(list1 *options, size_params params)
{
    int batch,w,h,c;
    w = params.w;
    h = params.h;
...
dropout_layer parse_dropout(list1 *options, size_params params)
{
...
layer parse_normalization(list1 *options, size_params params)
{
...
layer parse_batchnorm(list1 *options, size_params params)
{
    layer l = make_batchnorm_layer(params.batch, params.w, params.h, params.c);
    return l;
}

layer parse_shortcut(list1 *options, size_params params, network net)
{
...
layer parse_activation(list1 *options, size_params params)
{
    char *activation_s = option_find_str(options, "activation", "linear");
    ACTIVATION activation = get_activation(activation_s);
...
route_layer parse_route(list1 *options, size_params params, network net)
{
...
void parse_net_options(list1 *options, network *net)
{
